export default {
    state: {
        products: [
          ...
          },
          {
            ...
            items: [
              ...
              { id: 13, cardImage: "https://i.imgur.com/PhM88th.png", hoverImage: "https://i.imgur.com/572Glq7.png", cardDesc: "HigherGravity Baggy Fit Washed Gray Jeans.", cardPrice: 29.99, moreImages:['https://i.imgur.com/PhM88th.png'] },
      ...
      getters: {
        shirts(state) {
            return state.products.find(category => category.category ==='shirts').items
        },
        pants(state) {
